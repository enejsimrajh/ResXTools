namespace ResXTools.Mocks.Designer.Properties.Resources
{
    ...
    public sealed class ServiceDesignerTemplate
    {
        private readonly IStringLocalizer<ServiceDesignerTemplate> _localizer;

        public ServiceDesignerTemplate(IStringLocalizer<ServiceDesignerTemplate> localizer)
        {
